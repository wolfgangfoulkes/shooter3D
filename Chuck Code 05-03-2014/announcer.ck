public class Announcer {
    ...
    string screamToRespawn[3];
    
    me.dir() + "/audio/screamToRespawn1.wav" => screamToRespawn[0];
    me.dir() + "/audio/screamToRespawn2.wav" => screamToRespawn[1];
    me.dir() + "/audio/screamToRespawn3.wav" => screamToRespawn[2];
